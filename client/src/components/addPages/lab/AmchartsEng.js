...
class AmchartsEng extends Component {
  componentDidMount() {
    ...
    chart.data = [
      {
        ...
        year: '1',
        size: 13,
        text: 'Differentiated speech therapy',
      },
      {
        category: '',
        year: '2',
        size: 5,
        text: 'Specialized treatment for  bilingual children',
      },
      {
        category: '',
        year: '3',
      ...
      },
      {
        ...
        year: '5',
        size: 3,
        text: 'Ubiquitous services with high accessibility',
      },
    ]
  ...
  render() {
    return <div id="chartdiv2" style={{ width: '90%', height: '600px' }} />
  }
}

export default AmchartsEng
