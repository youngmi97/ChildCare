    ...
    >
        <Card style={{ width: "100%", height: "100%", borderRadius: "0px" }}>
            ...
            <Grid
              ...
              >
                <div>기본정보: ㅁ닝러ㅏㅣ넝라ㅣ머닝러ㅏㅣㄴ멍ㄴㅇ리ㅓㅁ니ㅏ어리ㅏㅁㄴ</div>
                <div>교육력: ㅁ닝러ㅏㅣ넝라ㅣ머닝러ㅏㅣㄴ멍ㄴㅇ리ㅓㅁ니ㅏ어리ㅏㅁㄴ</div>
                <div>발달력: ㅁ닝러ㅏㅣ넝라ㅣ머닝러ㅏㅣㄴ멍ㄴㅇ리ㅓㅁ니ㅏ어리ㅏㅁㄴ </div>
                <div>병력: ㅁ닝러ㅏㅣ넝라ㅣ머닝러ㅏㅣㄴ멍ㄴㅇ리ㅓㅁ니ㅏ어리ㅏㅁㄴ</div>
                <div>가족력: ㅁ닝러ㅏㅣ넝라ㅣ머닝러ㅏㅣㄴ멍ㄴㅇ리ㅓㅁ니ㅏ어리ㅏㅁㄴ</div>
