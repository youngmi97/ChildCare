...
const steps = [
  ...
  },
  {
    title: '전문가평가',
    content:
      '평가 당일 아동은 전문가와 일대일로 언어발달 평가를 진행하고, 부모님은 임동선 교수와 상담 시간을 갖습니다.',
    Ftitle: '교수님 상담 및 전문가 평가',
  },
  {
    title: '평가 결과 상담',
    content:
      '아동의 언어발달 평가 결과를 보고서로 부모님께 제공하고, 부모님은 이를 토대로 임동선 교수와 평과 결과에 대해 상담을 받습니다.',
    Ftitle: '평가 결과 상담',
  },
  {
    title: '부모상담',
  ...
  },
  {
    title: '진전평가',
    content:
      '매달 아동의 진전을 평가하고, 부모님은 이를 바탕으로 임동선 교수와 상담 시간을 갖습니다.',
